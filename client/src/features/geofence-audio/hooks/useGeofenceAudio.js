    ...
    const mapApiPois = (apiPois) =>
      apiPois
        ...
        return {
          ...
          stallId: apiPoi.stallId == null ? (apiPoi.StallId == null ? null : String(apiPoi.StallId)) : String(apiPoi.stallId),
          ...
          latitude,
          longitude,
          activationRadius: Number(apiPoi.activationRadius ?? apiPoi.ActivationRadius) || 30,
