  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-teal-950 px-4 py-12 text-white">
      <div className="mx-auto max-w-5xl">
        <header className="text-center"><Crown className="mx-auto text-amber-300" size={44} /><h1 className="mt-4 text-4xl font-black">{t('payment.premium_presentation_title')}</h1><p className="mt-3 text-slate-300">{t('payment.premium_desc')}</p><div className="mx-auto mt-5 inline-flex items-end gap-2 rounded-2xl border border-amber-300/30 bg-amber-300/10 px-6 py-3"><strong className="text-4xl font-black text-amber-300">30.000</strong><span className="pb-1 font-bold text-amber-100">VND / 30 {t('payment.days')}</span></div></header>
