export const appConfig = {
  ...
  vendorApiBaseUrl: import.meta.env.VITE_VENDOR_API_BASE_URL ?? 'http://localhost:5001/api/vendor',
  vendorAuthApiBaseUrl: import.meta.env.VITE_VENDOR_AUTH_API_BASE_URL ?? 'http://localhost:5001/api/vendor/auth',
