...
VALUES
  ...
  (
    ...
    15.8800580,
    108.3380470,
    ST_GeomFromText('POINT(108.338047 15.880058)'),
    '09:00-20:30',
    'APPROVED',
    0,
    0
...
VALUES
  (
    ...
    10.7722100,
    106.6983100,
    ST_GeomFromText('POINT(106.698310 10.772210)'),
    35,
    1,
    'ACTIVE'
  ),
  (
    ...
    10.7720300,
    106.6981900,
    ST_GeomFromText('POINT(106.698190 10.772030)'),
    25,
    0,
    'ACTIVE'
  ),
  (
    ...
    15.8801200,
    108.3381200,
    ST_GeomFromText('POINT(108.338120 15.880120)'),
    30,
    0,
    'ACTIVE'
  );
