...
var allowedOrigins = builder.Configuration
  ...
  .Get<string[]>() ?? ["https://bkpvp.top", "https://cs.bkpvp.top", "https://be.bkpvp.top", "http://localhost:5173", "http://127.0.0.1:5173", "http://localhost:5174", "http://127.0.0.1:5174", "http://localhost:5175", "http://127.0.0.1:5175", "http://localhost:5176", "http://127.0.0.1:5176", "http://localhost:3000", "http://127.0.0.1:3000", "http://localhost:3001", "http://127.0.0.1:3001"];
...
builder.Services.AddScoped<IDichVuThanhToan, CsdlDichVuThanhToan>();
builder.Services.AddScoped<ICommissionService, CommissionService>();
builder.Services.AddScoped<IAdminLogService, AdminLogService>();
builder.Services.AddScoped<IGeofenceService, GeofenceService>();
builder.Services.AddScoped<DichVuKichHoatThanhToan>();
